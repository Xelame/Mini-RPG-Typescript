...
export class Paladin extends Character{
    /**
     * 
     * @param name Nom du Paladin
     * @param physicalAttack Attaque physique du Paladin
     * @param physicalArmor Défense physique du Paladin
     * @param speed Vitesse du Paladin
     * @param maxHealth Point de vie du Paladin
     */
    constructor(name: string, physicalAttack: number,physicalArmor: number,speed: number,maxHealth: number,) {
        super(name, physicalAttack, physicalArmor, speed, maxHealth);
    }
    specialAttack(target : Character) :void{
        for (let i = 0 ; i < Fight.enemyTeam.length ; i++ ){
...
export class Voleur extends Character{
     ...
     * @param physicalAttack Attaque physique du Voleur
     * @param physicalArmor Défense physique du Voleur
     * @param speed Vitesse du Voleur
     * @param maxHealth Point de vie du Voleur
     */
    constructor(name: string, physicalAttack: 20,physicalArmor: number,speed: number,maxHealth: number,) {
        super(name, physicalAttack, physicalArmor, speed, maxHealth);
    }
    specialAttack(target : Character) :void{
