...
class GameManager {
    ...
    private generateMonsterParty(): Character[] {
        ...
        while (monsterParty.length < 3) {
            ...
            switch (luck) {
                case 0:
                    monsterParty.push(new Monstre("Vampire", '🧛', 50, 20, 5));
                    break;
                case 1:
                    monsterParty.push(new Monstre("Ogre", '👹', 30, 30, 2));
                    break;
                case 2:
                    monsterParty.push(new Monstre("Fantôme", '👻', 40, 10, 8));
                    break;
                case 3:
                    monsterParty.push(new Monstre("Zombie",'🧟', 40, 20, 3));
                    break;
                case 4:
